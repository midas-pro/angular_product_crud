<h1 align="center">
	<img alt="Product list logo" src="https://github.com/midas-pro/angular_product_crud/blob/main/frontend/src/assets/svg/checklist.svg" height="67px" width="71px" />
</h1>
...
<h1 align="center">
	<img alt="Project Screenshots" src="https://github.com/midas-pro/angular_product_crud/blob/main/screenshots/angular-project-crud.gif" />
</h1>
...
```bash
$ git clone https://github.com/midas-pro/angular_product_crud.git

$ cd angular_product_crud
...
This project is under the MIT license. See the [LICENSE](https://github.com/midas-pro/angular_product_crud/blob/master/LICENSE) for more information.
